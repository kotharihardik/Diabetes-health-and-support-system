...
const blogData = [
  {
    ...
    imgSrc: '../public/blogsImages/blog1.png',
  ...
  },
  {
    ...
    imgSrc: '../public/blogsImages/blog2.png',
  ...
  },
  {
    ...
    imgSrc: '../public/blogsImages/blog3.png',
    link: 'https://onlinelibrary.wiley.com/journal/17530407',
  },
  {
    title: 'What is Diabetes? Types, Symptoms, and Causes - Harvard Health',
    description:
      'Diabetes occurs when the body has trouble using the sugar it gets from food for energy. Sugar builds up in the bloodstream.',
    imgSrc: '../public/blogsImages/blog4.png',
    link: 'https://www.health.harvard.edu/topics/diabetes',
  },
  {
    title: 'PREVENTING DIABETES',
    description:
      'Yes, type 2 diabetes can be prevented with thoughtful lifestyle changes and plant-rich diets',
    imgSrc: '../public/blogsImages/blog5.png',
  ...
  },
  {
    ...
    imgSrc: '../public/blogsImages/blog6.png',
