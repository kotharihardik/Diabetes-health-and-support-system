      ...
      exercises: [
        {
          ...
          imageUrl: '../public/Exercise/Jumping Jacks.jpeg.jpg',
          onClick: () =>
            alert(
        ...
        },
        {
          ...
          imageUrl: '../public/Exercise/Deadlift.jpeg.jpg',
          onClick: () =>
            alert(
        ...
        },
        {
          ...
          imageUrl: '../public/Exercise/Surya Namaskar (Sun Salutation).jpeg.jpg',
          onClick: () =>
            alert(
      ...
      exercises: [
        {
          ...
          imageUrl: '../public/Exercise/Shavasana (Corpse Pose).jpg',
          onClick: () =>
            alert(
        ...
        },
        {
          ...
          imageUrl: '../public/Exercise/Bhramari Pranayama (Bee Breathing).webp',
          onClick: () =>
            alert(
        ...
        },
        {
          ...
          imageUrl: '../public/Exercise/Viparita Karani (Legs Up the Wall Pose).webp',
          onClick: () =>
            alert(
