    ...
    <div className="min-h-screen flex flex-col justify-between bg-gray-100">
      ...
      <header className="relative bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-center py-20 px-4">
        ...
        <p className="text-lg font-medium mb-8">
          Stay ahead of your health by assessing your risk of diabetes and getting personalized suggestions.
        </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <img src="../public/home1.png" alt="Predict" className="w-16 h-16 mb-4 mx-auto" />
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <img src="../public/home2.png" alt="Personalized" className="w-16 h-16 mb-4 mx-auto" />
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <img src="../public/home3.png" alt="Blogs" className="w-16 h-16 mb-4 mx-auto" />
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <img src="../public/home4.png" alt="Exercise" className="w-16 h-16 mb-4 mx-auto" />
